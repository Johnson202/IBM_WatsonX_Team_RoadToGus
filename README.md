...
IBM Granite-3.1-8B-Instruct model was chosen for optimal outputs in the Finance domain (based on available foundational models, in terms of cost vs. risk).
